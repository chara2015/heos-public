...
public interface PlayerAuth {
    ...
    /**
     * Whether login protection was explicitly armed for this player session.
     */
    boolean heos$isAuthenticationRequired();

    /**
     * Explicitly arms or disarms login protection for this player session.
     */
    void heos$setAuthenticationRequired(boolean required);
